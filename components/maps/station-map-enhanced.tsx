...
export function StationMapEnhanced({ stations, selectedStation, onStationClick }: StationMapEnhancedProps) {
  useEffect(() => {
            ...
            <div className="p-2 min-w-[250px]">
              ...
              <div className="space-y-2 mb-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">{station.classicBikesAvailable}</span>
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">{station.electricBikesAvailable}</span>
                </div>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">{station.smartBikesAvailable}</span>
                </div>
              </div>
              ...
              <div className="border-t pt-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium">{station.docksAvailable}/{station.totalDocks}</span>
                </div>
              </div>
